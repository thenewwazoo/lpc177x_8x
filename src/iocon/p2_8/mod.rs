...
impl<'a> _FUNCW<'a> {
    ...
    pub fn p2_8(self) -> &'a mut W {
        self.variant(FUNCW::P2_8)
    }
    #[doc = "CAN2 transmitter output."]
    #[inline]
    pub fn can_td2(self) -> &'a mut W {
        self.variant(FUNCW::CAN_TD2)
    }
    #[doc = "Transmitter output for UART2."]
    #[inline]
    pub fn u2_txd(self) -> &'a mut W {
        self.variant(FUNCW::U2_TXD)
    }
    #[doc = "Clear to Send input for UART1."]
    #[inline]
    pub fn u1_cts(self) -> &'a mut W {
        self.variant(FUNCW::U1_CTS)
    }
    #[doc = "Ethernet MIIM clock."]
    #[inline]
    pub fn enet_mdc(self) -> &'a mut W {
        self.variant(FUNCW::ENET_MDC)
    }
    #[doc = "LCD data."]
    #[inline]
    pub fn lcd_vd_2(self) -> &'a mut W {
        self.variant(FUNCW::LCD_VD_2)
    }
    #[doc = "LCD data."]
    #[inline]
