...
impl<'a> _FUNCW<'a> {
    ...
    pub fn u1_dcd(self) -> &'a mut W {
        self.variant(FUNCW::U1_DCD)
    }
    #[doc = "Match output for Timer 2, channel 2."]
    #[inline]
    pub fn t2_mat2(self) -> &'a mut W {
        self.variant(FUNCW::T2_MAT2)
    }
    #[doc = "Trace data, bit 2."]
    #[inline]
    pub fn tracedata_2(self) -> &'a mut W {
        self.variant(FUNCW::TRACEDATA_2)
    }
    #[doc = "Frame pulse (STN). Vertical synchronization pulse (TFT)."]
    #[inline]
    pub fn lcd_fp(self) -> &'a mut W {
        self.variant(FUNCW::LCD_FP)
    }
