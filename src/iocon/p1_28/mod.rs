...
impl<'a> _FUNCW<'a> {
    ...
    pub fn pwm1_cap0(self) -> &'a mut W {
        self.variant(FUNCW::PWM1_CAP0)
    }
    #[doc = "Match output for Timer 0, channel 0."]
    #[inline]
    pub fn t0_mat0(self) -> &'a mut W {
        self.variant(FUNCW::T0_MAT0)
    }
    #[doc = "Motor control PWM channel 2, output A."]
    #[inline]
    pub fn mc_2a(self) -> &'a mut W {
        self.variant(FUNCW::MC_2A)
    }
    #[doc = "Slave Select for SSP0."]
    #[inline]
    pub fn ssp0_ssel(self) -> &'a mut W {
        self.variant(FUNCW::SSP0_SSEL)
    }
    #[doc = "LCD data."]
    #[inline]
