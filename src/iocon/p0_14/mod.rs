...
impl<'a> _FUNCW<'a> {
    ...
    pub fn p0_14(self) -> &'a mut W {
        self.variant(FUNCW::P0_14)
    }
    #[doc = "Host Enabled status for USB port 2."]
    #[inline]
    pub fn usb_hsten2(self) -> &'a mut W {
        self.variant(FUNCW::USB_HSTEN2)
    }
    #[doc = "Slave Select for SSP1."]
    #[inline]
    ...
    pub fn usb_connect2(self) -> &'a mut W {
        self.variant(FUNCW::USB_CONNECT2)
    }
