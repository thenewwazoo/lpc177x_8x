...
impl<'a> _FUNCW<'a> {
    ...
    pub fn p1_29(self) -> &'a mut W {
        self.variant(FUNCW::P1_29)
    }
    #[doc = "USB port 1 I2C serial data (OTG transceiver)."]
    #[inline]
    pub fn usb_sda1(self) -> &'a mut W {
        self.variant(FUNCW::USB_SDA1)
    }
    #[doc = "Capture input for PWM1, channel 1."]
    #[inline]
    pub fn pwm1_cap1(self) -> &'a mut W {
        self.variant(FUNCW::PWM1_CAP1)
    }
    #[doc = "Match output for Timer 0, channel 1."]
    #[inline]
    pub fn t0_mat1(self) -> &'a mut W {
        self.variant(FUNCW::T0_MAT1)
    }
    #[doc = "Motor control PWM channel 2, output B."]
    #[inline]
    pub fn mc_2b(self) -> &'a mut W {
        self.variant(FUNCW::MC_2B)
    }
    #[doc = "Transmitter output for USART4 (input/output in smart card mode)."]
    #[inline]
    pub fn u4_txd(self) -> &'a mut W {
        self.variant(FUNCW::U4_TXD)
    }
    #[doc = "LCD data."]
    #[inline]
    pub fn lcd_vd_15(self) -> &'a mut W {
        self.variant(FUNCW::LCD_VD_15)
    }
    #[doc = "LCD data."]
    #[inline]
    pub fn lcd_vd_23(self) -> &'a mut W {
        self.variant(FUNCW::LCD_VD_23)
    }
