...
impl<'a> _FUNCW<'a> {
    ...
    pub fn p2_9(self) -> &'a mut W {
        self.variant(FUNCW::P2_9)
    }
    #[doc = "USB1 SoftConnect control. Signal used to switch an external 1.5 kW resistor under the software control. Used with the SoftConnect USB feature."]
    #[inline]
    pub fn usb_connect1(self) -> &'a mut W {
        self.variant(FUNCW::USB_CONNECT1)
    }
    #[doc = "Receiver input for UART2."]
    #[inline]
    pub fn u2_rxd(self) -> &'a mut W {
        self.variant(FUNCW::U2_RXD)
    }
    #[doc = "Receiver input for USART4."]
    #[inline]
    pub fn u4_rxd(self) -> &'a mut W {
        self.variant(FUNCW::U4_RXD)
    }
    #[doc = "Ethernet MIIM data input and output."]
    #[inline]
    pub fn enet_mdio(self) -> &'a mut W {
        self.variant(FUNCW::ENET_MDIO)
    }
    #[doc = "LCD data."]
    #[inline]
