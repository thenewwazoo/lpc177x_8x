...
impl<'a> _FUNCW<'a> {
    ...
    pub fn p1_24(self) -> &'a mut W {
        self.variant(FUNCW::P1_24)
    }
    #[doc = "D- receive data for USB port 1 (OTG transceiver)."]
    #[inline]
    pub fn usb_rx_dm1(self) -> &'a mut W {
        self.variant(FUNCW::USB_RX_DM1)
    }
    #[doc = "Pulse Width Modulator 1, channel 5 output."]
    #[inline]
    pub fn pwm1_5(self) -> &'a mut W {
        self.variant(FUNCW::PWM1_5)
    }
    #[doc = "Quadrature Encoder Interface INDEX input."]
    #[inline]
    pub fn qei_idx(self) -> &'a mut W {
        self.variant(FUNCW::QEI_IDX)
    }
    #[doc = "Motor control PWM channel 2 feedback input."]
    #[inline]
    pub fn mc_fb2(self) -> &'a mut W {
        self.variant(FUNCW::MC_FB2)
    }
    #[doc = "Master Out Slave in for SSP0."]
    #[inline]
    pub fn ssp0_mosi(self) -> &'a mut W {
        self.variant(FUNCW::SSP0_MOSI)
    }
    #[doc = "LCD data."]
    #[inline]
    pub fn lcd_vd_10(self) -> &'a mut W {
        self.variant(FUNCW::LCD_VD_10)
    }
    #[doc = "LCD data."]
    #[inline]
    pub fn lcd_vd_14(self) -> &'a mut W {
        self.variant(FUNCW::LCD_VD_14)
    }
