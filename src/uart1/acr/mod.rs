...
impl AUTORESTARTR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ...
            AUTORESTARTR::RESTART_ON_TIMEOUT => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> AUTORESTARTR {
        match value {
            ...
            true => AUTORESTARTR::RESTART_ON_TIMEOUT,
        }
    }
    ...
    pub fn is_restart_on_timeout(&self) -> bool {
        *self == AUTORESTARTR::RESTART_ON_TIMEOUT
    }
}
...
impl ABEOINTCLRR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ABEOINTCLRR::NO_OP => false,
            ABEOINTCLRR::CLEAR_INT => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> ABEOINTCLRR {
        match value {
            false => ABEOINTCLRR::NO_OP,
            true => ABEOINTCLRR::CLEAR_INT,
        }
    }
    #[doc = "Checks if the value of the field is `NO_OP`"]
    #[inline]
    pub fn is_no_op(&self) -> bool {
        *self == ABEOINTCLRR::NO_OP
    }
    #[doc = "Checks if the value of the field is `CLEAR_INT`"]
    #[inline]
    pub fn is_clear_int(&self) -> bool {
        *self == ABEOINTCLRR::CLEAR_INT
    }
}
...
impl ABTOINTCLRR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            ABTOINTCLRR::NO_OP => false,
            ABTOINTCLRR::CLEAR_INT => true,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
    ...
    pub fn _from(value: bool) -> ABTOINTCLRR {
        match value {
            false => ABTOINTCLRR::NO_OP,
            true => ABTOINTCLRR::CLEAR_INT,
        }
    }
    #[doc = "Checks if the value of the field is `NO_OP`"]
    #[inline]
    pub fn is_no_op(&self) -> bool {
        *self == ABTOINTCLRR::NO_OP
    }
    #[doc = "Checks if the value of the field is `CLEAR_INT`"]
    #[inline]
    pub fn is_clear_int(&self) -> bool {
        *self == ABTOINTCLRR::CLEAR_INT
    }
}
...
impl AUTORESTARTW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ...
            AUTORESTARTW::RESTART_ON_TIMEOUT => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _AUTORESTARTW<'a> {
    ...
    pub fn restart_on_timeout(self) -> &'a mut W {
        self.variant(AUTORESTARTW::RESTART_ON_TIMEOUT)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl ABEOINTCLRW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ABEOINTCLRW::NO_OP => false,
            ABEOINTCLRW::CLEAR_INT => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _ABEOINTCLRW<'a> {
    ...
    pub fn no_op(self) -> &'a mut W {
        self.variant(ABEOINTCLRW::NO_OP)
    }
    #[doc = "Writing a 1 will clear the corresponding interrupt in the IIR."]
    #[inline]
    pub fn clear_int(self) -> &'a mut W {
        self.variant(ABEOINTCLRW::CLEAR_INT)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl ABTOINTCLRW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            ABTOINTCLRW::NO_OP => false,
            ABTOINTCLRW::CLEAR_INT => true,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _ABTOINTCLRW<'a> {
    ...
    #[inline]
    pub fn no_op(self) -> &'a mut W {
        self.variant(ABTOINTCLRW::NO_OP)
    }
    #[doc = "Writing a 1 will clear the corresponding interrupt in the IIR."]
    #[inline]
    pub fn clear_int(self) -> &'a mut W {
        self.variant(ABTOINTCLRW::CLEAR_INT)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
