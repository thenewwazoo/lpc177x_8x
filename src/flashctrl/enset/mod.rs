...
#[doc = r" Proxy"]
pub struct _RDWR_SET_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _RDWR_SET_ENW<'a> {
...
#[doc = r" Proxy"]
pub struct _PROG1_SET_ENW<'a> {
    w: &'a mut W,
}
impl<'a> _PROG1_SET_ENW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[inline]
    pub fn rdwr_set_en(&mut self) -> _RDWR_SET_ENW {
        _RDWR_SET_ENW { w: self }
    }
    ...
    #[inline]
    pub fn prog1_set_en(&mut self) -> _PROG1_SET_ENW {
        _PROG1_SET_ENW { w: self }
    }
}
